...
public class AppointmentBookingList {
    public AppointmentBookingList(){
        try {
            ...
            if (con != null) {
                ...
                viewTableFrame.setTitle("Appointments Table");
                ...
                // Icon add
                ImageIcon img = new ImageIcon(AppointmentBookingList.class.getResource("MedManageLogo.png"));
