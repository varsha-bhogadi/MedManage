...
public class DoctorManagementList {
    public DoctorManagementList() {
        try {
            ...
            if (con != null) {
                ...
                viewTableFrame.setTitle("Doctor Table");
                ...
                // Icon add
                ImageIcon img = new ImageIcon(DoctorManagementList.class.getResource("MedManageLogo.png"));
