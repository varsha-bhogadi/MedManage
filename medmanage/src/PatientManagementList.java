...
public class PatientManagementList {
    public PatientManagementList() {
        try {
            ...
            if (con != null) {
                ...
                viewTableFrame.setTitle("Patient Table");
                ...
                // Icon add
                ImageIcon img = new ImageIcon(PatientManagementList.class.getResource("MedManageLogo.png"));
