...
def sendConfirmationEmail(to_email):
    ...
    msg['To'] = to_email
    msg['Subject'] = 'MedManage Doctor Registration Successful'
    ...
    body = f"""
        ...
        <body>
            <div class="mid_background">
                <div class="content">
                    <div class="head1">Dear {doctor_name},</div>
                    ...
                    <div class="line"></div>
                    <div class="head3">Doctor Registration Details :</div>
                    <div class="bold">
                        <table>
                            <tr>
                                <td>Doctor ID:</td>
                    ...
                    <div class="imp">Please remember the doctor's ID as it is essential for future reference.</div>
                    <div class="line"></div>
                    ...
                    <div class="head2">
                        ...
                        We look forward to working with you and providing the best possible service.
                    </div>
