...
def sendConfirmationEmail(to_email):
    ...
    msg['To'] = to_email
    msg['Subject'] = 'MedManage Staff Registration Successful'
    ...
    body = f"""
        ...
        <body>
            <div class="mid_background">
                <div class="content">
                    <div class="head1">Dear {staff_name},</div>
                    ...
                    <div class="line"></div>
                    <div class="head3">Staff Registration Details :</div>
                    <div class="bold">
                        <table>
                            <tr>
                                <td>Staff ID:</td>
                    ...
                    <div class="imp">Please remember the staff's ID as it is essential for future reference.</div>
                    <div class="line"></div>
